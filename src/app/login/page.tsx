...
function LoginFormFallback() {
  return (
    <div className="bg-white/80 backdrop-blur rounded-2xl shadow-xl p-8 border border-amber-100 animate-pulse">
      ...
      <div className="mt-6 h-4 bg-stone-100 rounded w-3/4 mx-auto" />
    </div>
  );
}
