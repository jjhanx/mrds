...
### 추가
- **도구**: `osmd-universal-viewer/` — 별도 Vite 앱. MusicXML/MXL과 NWC(→MusicXML 변환)를 OpenSheetMusicDisplay로 표시·재생(soundfont-player / osmd-audio-player 벤더). NWC 파서는 브라우저용으로 `pako` inflate 사용
